...
from helper.utils import load_data, preprocess_data, statistical_info, check_null, plot_clusters_and_centroids
...
if __name__ == "__main__":
    ...
    plot_clusters_and_centroids(X_scaled,labels,kmeans_scratch)
